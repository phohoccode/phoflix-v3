  ...
  return (
    <Box className="flex flex-col gap-12">
      <Box className="lg:mt-32 mt-24">
        ...
        <Box className="flex flex-col lg:rounded-2xl overflow-hidden lg:px-4">
          <SectionVideo />
          <Box className="p-4 bg-[#08080a]">
      ...
      <RootLayout>
        <Box className="flex flex-col gap-12 px-4">
          <Box className="flex gap-12 lg:flex-row flex-col pb-12 border-b border-[#ffffff10]">
            ...
            <Box className="xl:flex-2 flex-1 text-[#f1c40f]">
          ...
          <MovieSuggesstions
            colums={{ base: 3, md: 3, lg: 5, xl: 6, "2xl": 8 }}
